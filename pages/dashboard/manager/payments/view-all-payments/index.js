...
import {  morePaymentData } from "@/data/properties"
...
const AllPayments = () => {
  ...
  const tabs = ["All payments", "Rentals", "For sale"]
        ...
        <div className="border rounded-lg my-8 p-6">
          ...
          <>
            ...
            <div className="grid text-left mt-6">
              {morePaymentData.map((property, i) => (
                <PaymentsData index={i} key={i} data={property} />
              ))}
            </div>
          </>
        </div>
    ...
    return [
      {
        to: "",
        value: "Quote",
        src: "/assets/icons/charm_circle-tick.svg",
      },
      {
