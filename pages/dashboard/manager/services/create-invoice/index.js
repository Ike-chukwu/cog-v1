...
import FilterModal from "@/components/manager/services/filter-modal"
import ServicesRecurringFilterModal from "@/components/manager/services/recurring-modal"
import ServicesFilterModal from "@/components/manager/services/recurring-modal"
    ...
    <Dashboard>
      <main className="p-10 relative">
        ...
        <div className="flex flex-col gap-4 items-start right-[43px] top[10px] absolute">
          ...
          >
            {recurringStatus ? <DownloadIcon /> : <Gear />}
            <span>{recurringStatus ? "Download" : "Recurring Invoice"}</span>
          </button>
          ...
          <div className="">
            <p className="mb-2 text-[10px] font-[500]">
              ...
              {vendorNames?.map((vendor) => (
                <span className="ml-[0.5px]" key={name}>
                  {vendor.value},
                </span>
              ))}
            </p>
