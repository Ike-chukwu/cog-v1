        ...
        >
          ...
          <div className="flex flex-col gap-y-3">
            <h1 className="text-[#19191A] text-[18px] font-semibold">
              Service request from Ajibola Quadri at Ikorodu property
            </h1>
        ...
        <section className="mt-5 pr-5">
                ...
                >
                  <span
                    ...
                    onClick={(e) =>
                      closePopupHandler(
                        e,
                        "/dashboard/manager/services/add-service"
                      )
                    }
                  >
                    <Image
                  ...
                  <span
                    ...
                    onClick={(e) =>
                      closePopupHandler(
                        e,
                        "/dashboard/manager/services/view-all-services"
                      )
                    }
                  >
                    <Image
          ...
          <div className="pt-10 flex justify-between gap-x-5">
            {[
              ...
              {
                header: "Pending payments to vendors",
                val: "-10,000.000",
          ...
          <div className="flex pt-10">
            <Link
              href={"/dashboard/manager/services/custom-report"}
              className="ml-auto"
            >
