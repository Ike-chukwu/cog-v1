...
import { Chart } from "@/components/manager/employees/Chart"
import { EmployeeBigcard } from "@/components/manager/employees/stages/EmployeeBigCard/EmployeeBigCard"
    ...
    <Dashboard>
      <main className="p-10">
        <nav className="flex justify-between">
          <div>
            <h1 className="text-[#4B4B4B] text-[38px] font-bold">Back-office</h1>
          </div>
          <div>
        ...
        <div className="border border-[#62909F] py-9 px-7">
          <header className="flex flex-col items-center justify-end mb-6">
            <h1 className="font-bold text-dark text-3xl">{`Employee name`}</h1>
            ...
            <div className="w-[50%]">
              <div className="flex gap-6 flex-col">
                <div className="flex gap-3 justify-between">
                  <SmallCard text={"Overdue payment"} num={1} />
                  <SmallCard text={"Payment tally"} num={14} />
                  <SmallCard text={"Assumed payments"} num={15} />
                </div>
