...
const ServicesFilterModal = ({ toggleFilterModal }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mb-4">
        <p className="text-sm font-medium mb-2 text-[#55656F]">Filter status</p>
        <div className="flex space-x-4">
          ...
          <button
            className={`rounded-full px-4 py-2 ${
              selectedCategory === "Due in 6 months"
                ? "bg-[#386A8B] text-white"
                : "border border-[#B1B1B4] text-[#B1B1B4]"
            }`}
            onClick={() => handleCategoryChange("Due in 6 months")}
          >
            Overdue
          </button>
        </div>
