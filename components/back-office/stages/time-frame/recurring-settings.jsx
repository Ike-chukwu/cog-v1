...
const RecurringSettingsInSchedule = ({ register }) => {
  return (
    <Wrapper
      header="Recurring settings"
      subHead="Kindly set a recurring protocols for the schedule"
    >
...
export default RecurringSettingsInSchedule
